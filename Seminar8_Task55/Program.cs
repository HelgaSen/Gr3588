//Задайте двумерный массив. Напишите программы, которая заменит строки на столбцы. В случаеЮ если это невозможно, программа должна вывести сообщение для пользователя  
...
// Печать двумерного массива со случайной цветовой раскраской 
...
// Проверка возможности замены строк на столбцы, т.е. кол-во строк = кол-ву столбцов
bool TTest(int[,]arr)
{
