// Задайте двумерный массив из целых чисел. Напишите программу, которая удалит строчку и столбец, на пересечении которых расположен наименьший элемент массива.
...
//Удаление строки и столбца по заданным координатам их пересечения
